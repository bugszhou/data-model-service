(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash.isobject'), require('lodash.isempty'), require('lodash.isarray'), require('lodash.mapvalues'), require('lodash.get'), require('lodash.topairs'), require('type-of')) :
	typeof define === 'function' && define.amd ? define(['exports', 'lodash.isobject', 'lodash.isempty', 'lodash.isarray', 'lodash.mapvalues', 'lodash.get', 'lodash.topairs', 'type-of'], factory) :
	(global = global || self, (function () {
		var current = global['data-model-service'];
		var exports = global['data-model-service'] = {};
		factory(exports, global.isObject, global.isEmpty, global.isArray, global.mapValues, global.getVal, global.toPairs, global.typeOf);
		exports.noConflict = function () { global['data-model-service'] = current; return exports; };
	}()));
}(this, function (exports, isObject, isEmpty, isArray, mapValues, getVal, toPairs, typeOf) { 'use strict';
	...
	getVal = getVal && getVal.hasOwnProperty('default') ? getVal['default'] : getVal;
